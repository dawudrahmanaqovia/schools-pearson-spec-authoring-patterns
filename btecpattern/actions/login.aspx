    ...
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                Request.QueryString["logoff"].ToLowerInvariant() == "true")
            {
                ...
                {
                    HttpCookie myCookie = new HttpCookie("pearsonCMS");
        ...
        protected void LogIn_Clicked(object sender, EventArgs e)
        {
            ...
            Uri targetUri = new Uri("http://localhost:8080/alfresco/service/api/login.json?u=admin&pw=password");
            ...
            Response.Cookies["pearsonCMS"]["alf_ticket"] = jsonResponse;
            Response.Cookies["pearsonCMS"]["username"] = username;
            Response.Cookies["pearsonCMS"].Expires = DateTime.Now.AddDays(1d);
            ...
            {
				// Relax if password is welcome123
